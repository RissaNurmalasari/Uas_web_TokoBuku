            ...
            <div class="col-12">
                <div class="card mb-4 row">
                    <div class="card-header pb-4">
                        <a href="/admin/buku/create"> <button type="submit" class="btn btn-success">Tambah</button></a>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ml-3">
                                                <img src="{{ asset($post->image) }}" class="img-fluid rounded"
                                                    alt="{{ $post->name }}"
                                                    style="width: 100px; height: 50px; border-radius: 12px;">
                                            </td>
                                            ...
                                            {{-- <td>
                                                <div class=" d-flex px-3 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">{{ $post->kategori->name }}</h6>
                                            ...
                                            <td>
                                                <div class="btn-group mr-3">
                                                    <a href="/admin/buku/{{ $post->id }}/edit"
                                                ...
                                                <div class="btn-group">
                                                    <form method="post" id="deleteForm"
                                                        action="{{ route('adminbuku.destroy', $post->id) }}">
                                                        @csrf
                                                        @method('delete')
                                                        <button type="button"
                                                            class="text-danger badge badge-sm badge-secondary bg-transparent border-0"
                                                            onclick="deleteCategory('{{ $post->id }}')">Delete</button>
                                                    </form>
                                                </div>
                                            </td>
                                        </tr>
